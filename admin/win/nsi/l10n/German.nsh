...
StrCpy $InstallMsiexec_MESSAGEBOX_TEXT "Die kDrive Lite Sync-Erweiterung wird nicht installiert, da Microsoft App Installer fehlt. Bitte installieren Sie es und starten Sie die Installation von kDrive neu, um Lite Sync verwenden zu können."
