...
StrCpy $InstallMsiexec_MESSAGEBOX_TEXT "The kDrive Lite Sync extension will not be installed because Microsoft App Installer is missing. Please install it and then restart the installation of kDrive in order to be able to use Lite Sync."
